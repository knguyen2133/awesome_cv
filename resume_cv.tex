...
\name{Kevin}{Nguyen}
\address{473 West Happfield Drive, Arlington Heights, IL}
\mobile{682-241-8753}

\email{knguyen2133@gmail.com}
%\homepage{}
\github{knguyen2133}
\linkedin{knguyen2133}
%\stackoverflow{SOid}{SOname}
%\xing{xing name}
%\extrainfo{test} % Other text you want to include on this line

\position{Embedded Software Engineer} % Your expertise/fields

\makecvfooter{\today}{Kevin Nguyen~~~·~~~Résumé}{\thepage} % Specify the letter footer with 3 arguments: (<left>, <center>, <right>), leave any of these blank if they are not needed

...
\geometry{left=1.75cm, top=1.5cm, right=1.75cm, bottom=1.5cm, footskip=.25cm} % Configure page margins with geometry
...
\position{Software Developer{\enskip\cdotp\enskip}Event Streaming} % Your expertise/fields
\quote{``First, solve the problem. Then, write the code."} % A quote or statement

\makecvfooter{\today}{Edward Vaisman~~~·~~~Résumé}{\thepage} % Specify the letter footer with 3 arguments: (<left>, <center>, <right>), leave any of these blank if they are not needed

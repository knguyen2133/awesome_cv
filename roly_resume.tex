...
\geometry{left=2.5cm, top=2.0cm, right=2.5cm, bottom=2.5cm, footskip=1.5cm} % Configure page margins with geometry
...
\name{Rolando}{Garcia}
\address{23 Glebe Rd. West, Apt. 23, Toronto, ON  M5P 0A1, Canada}
\mobile{(+1) 416-414-3370}

\email{rolygarcor@gmail.com}
%\homepage{www.posquit0.com}
%\github{eddyv}
\linkedin{rolando-garcia-423759141}
%\skype{skypeid}
...
\position{Commerical Broker{\enskip\cdotp\enskip} Real Estate} % Your expertise/fields

\makecvfooter{\today}{Rolando Garcia~~~·~~~Résumé}{\thepage} % Specify the letter footer with 3 arguments: (<left>, <center>, <right>), leave any of these blank if they are not needed
